...
%>
    ...
    conn.close();  
    %>
    <a href="updateosques.jsp"><input type="button" value="Add Question" class="signout"></a><a href="deleteosques.jsp"><input type="button" value="Delete Question" class="signout"></a>
</div>
