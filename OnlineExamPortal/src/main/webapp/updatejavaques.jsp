...
.text{
    ...
    <body > 
         <a href="modifyjava.jsp"><input type="button" value="Back" class="signout"></a><br><br>
            <div class="container">
	...
	<br>
	<input type="submit" value="ADD QUESTIONS" class="signout"  style="margin-left:200px;"> <a href="viewjavaquestions.jsp"><input type="button" value="VIEW QUESTIONS" class="signout"></a>
