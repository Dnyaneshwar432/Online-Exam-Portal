...
<b>
	<div class="container">
    <a href="modifyc.jsp"><input type="button" value="Home" class="signout"></a><br><br>
    <a href="deletecques.jsp"><input type="button" value="Delete more questions" class="signout"></a><br><br></div>
<% 
