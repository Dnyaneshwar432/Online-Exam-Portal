...
ques= new ArrayList<>();
	...
	%>
	<div class="container">
	<form method="post" action="saveos.jsp">
    <b style="font-size:1.4em;color:#00ff80;"><i>
    <%
...
<script type="text/javascript">window.onload = CreateTimer("timer", 60);</script>
  ...
  <% 
    ...
    if(qn==30){
    %>
        <tr><td><input type="submit" value="Submit" style="width:103px";></td><td><input type="reset" value="Clear" style="width:120px; height:30px; margin-top:15px;"></td></tr>
    <%
     }
    else{
    %>
