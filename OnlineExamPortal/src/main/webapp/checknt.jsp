...
margin-top: -100px;
    ...
    <a href="viewntresult.jsp"><input type="button" value="View Result" style="color:green;background:#F1F0D1;padding-top:5px;padding-right:5px;padding-bottom:5px;padding-left:5px;border-radius:4px;border:none;border-bottom:4px solid #27aE60;cursor:pointer;height:40px;width:100px; "> </a>
	
    </form>
 <%
   String s=(String)session.getAttribute("email");
    Connection conn=Connect_File.getConnection();
    String query2="select * from nt_answers where email=?";
    PreparedStatement ps=conn.prepareStatement(query2);
    PreparedStatement ps2=conn.prepareStatement("select * from nt_questions");
    ps.setString(1,s);
	...
	conn.close(); 
	%>
	 <jsp:forward page="ntques.jsp"></jsp:forward>
	<%
	}
    %>
